...
*/
const fraseSpider = 'Grandes poderes trazem grandes responsabilidades.'
console.log(fraseSpider)
...
const mdn = mozilla.slice(0, 1)+mozilla.slice(mozilla.indexOf('D'), mozilla.indexOf('e'))
    +mozilla.slice(mozilla.indexOf('N'), mozilla.lastIndexOf('e'))
...
const ultimaLetra = randomWord.slice(randomWord.length - 1, randomWord.length)
...
let newName = name[0].toUpperCase()+name.slice(1, 7)+name[7].toUpperCase()+name.slice(8, name.length)
console.log(newName)
/*
...
newName = `${name[0].toUpperCase()}${name.slice(1, 7)}${name[7].toUpperCase()}${name.slice(8, name.length)}`
console.log(newName)