...
const my3FavoriteTVShows = ['How i met your mother', 'The Walking Dead', 'Two and a half man']

const sentence = `Minhas 3 séries favoritas são: ${my3FavoriteTVShows.join(', ')}.`.replace(', Tw', ' e Tw')
...
*/
const number = 39
const convert = `A string que a "typeSentence" armazena tem mais de ${number}  
...
/*
  ...
  - Você sabe por que essa conversão resultou em true?
    R: crazyOperation resulta em 1, que não está entre os falsyValues.
*/
